...
async def advantage_spoll_choker(bot, query):
    ...
    if k==False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie Not Found In DataBase or It is Not Released')
...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("𝐈 𝐜𝐨𝐮𝐥𝐝𝐧'𝐭 𝐟𝐢𝐧𝐝 𝐚𝐧𝐲𝐭𝐡𝐢𝐧𝐠 𝐫𝐞𝐥𝐚𝐭𝐞𝐝 𝐭𝐨 𝐭𝐡𝐚𝐭\n𝐃𝐢𝐝 𝐲𝐨𝐮 𝐦𝐞𝐚𝐧 𝐚𝐧𝐲 𝐨𝐧𝐞 𝐨𝐟 𝐭𝐡𝐞𝐬𝐞?\nനിങ്ങൾ ഉദ്ദേശിച്ച മൂവി താഴെ കാണുന്ന വല്ലോം ആണ് എങ്കിൽ.\𝐧അതിൽ ക്ലിക്ക് ചെയ്യുക", reply_markup=InlineKeyboardMarkup(btn))
