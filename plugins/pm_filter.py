...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
       return await query.answer("വിളച്ചിൽ എടുകുന്നോ കുഞ്ഞിപുഴു നിനക്ക് വേണേൽ നീ Search ചെയ്യൂ കാരണം എനിക്ക് വേറെ പണി ഇല്ല😅. മാമനോട് ഒന്നും തോന്നല്ലേ 😇", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
