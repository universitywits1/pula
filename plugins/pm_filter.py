    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('𝐂𝐡𝐞𝐜𝐤 𝐏𝐦. 𝐈 𝐇𝐚𝐯𝐞 𝐒𝐞𝐧𝐭 𝐅𝐢𝐥𝐞𝐬 𝐈𝐧 𝐏𝐌\𝐧\𝐧മൂവി നിങ്ങൾക് 𝐩𝐞𝐫𝐬𝐨𝐧𝐚𝐥 ആയി അയച്ചു',show_alert = True)
