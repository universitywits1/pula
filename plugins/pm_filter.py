...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
       return await query.answer("വിളച്ചിൽ എടുക്കുന്നേ കുഞ്ഞിപുഴു\nനിനക്ക് വേണമെങ്കിൽ നീ 𝐬𝐞𝐚𝐫𝐜𝐡 ചെയ്യൂ\nകാരണം എനിക്ക് വേറെ പണി ഇല്ല😅.\nമാമനോട് ഒന്നും തോന്നല്ലേ 😇", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
