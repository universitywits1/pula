...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
       return await query.answer("<b>മറ്റുള്ളവർ 𝐬𝐞𝐚𝐫𝐜𝐡 ആക്കിയ ലിസ്റ്റ്ല്\nകൈ ഇടാതെ സ്വന്തമായി 𝐬𝐞𝐚𝐫𝐜𝐡\nചെയ്തിട്ട് അതിൽ നോക്കുക👹</b>", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
...
async def advantage_spoll_choker(bot, query):
    ...
    if int(user) != 0 and query.from_user.id != int(user):
        return await query.answer("<b>മറ്റുള്ളവർ സർച്ച് ആക്കിയ ലിസ്റ്റ്ല്\nകൈ ഇടാതെ സ്വന്തമായി സർച്ച്\nചെയ്തിട്ട് അതിൽ നോക്കുക👹</b>", show_alert=True)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"𝐇𝐞𝐫𝐞 𝐢𝐬 𝐰𝐡𝐚𝐭 𝐢 𝐟𝐨𝐮𝐧𝐝 𝐟𝐨𝐫 𝐲𝐨𝐮𝐫 𝐫𝐞𝐪𝐮𝐞𝐬𝐭 <b>{search}</b>"
